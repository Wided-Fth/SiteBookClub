		...
		<footer id="page-footer" class="<?php echo esc_attr(ashe_options( 'general_footer_width' )) === 'boxed' ? 'boxed-wrapper ': ''; ?>clear-fix">
			...
			<div class="footer-copyright">
				...
				$copyright = str_replace( '$year', '2020', $copyright );
				...
				<div class="credit">
					...
					//printtf( __('جميع الحقوق محفوظة © ألف .. ياء 2020','ashe'));
					printf( __( '2020 جميع الحقوق محفوظة %1$s <a href="%2$s">%3$s</a>', 'ashe' ), esc_html('©'), esc_url('http://localhost/SiteBookClub/'), ' ألف .. ياء ');
					//printf( __( '%1$s جميع الحقوق محفوظة', 'ashe' ), esc_html( $theme_data->Name ), esc_url( 'http://wp-royal.com/' ), $theme_data->Author );
